                    ...
                    <div class="row gx-lg-5 align-items-center">
                        <div class="col-lg-6 mb-5 mb-lg-0">
                            <h1 class="my-5 display-3 fw-bold ls-tight">
                                Welcome Back! <br />
                                <span class="text-primary">Sign in to your account</span>
                            </h1>
                            <p style="color: hsl(217, 10%, 50.8%)">
                                Access exclusive features by signing into your account. If you don't have an account, create one easily!
                            </p>
                        </div>

                        <div class="col-lg-6 mb-5 mb-lg-0">
                            <h3 style="color: #C5837C;" class="login-message">${requestScope.mess}</h3>
                            <div class="card">
                                <div class="card-body py-5 px-md-5">
                                    <form action="loginServlet" method="post">
                                        <!-- Email input -->
                                        <div class="form-outline mb-4">
                                            <input type="text" id="loginEmail" name="userName" class="form-control" placeholder="User Name" required />
                                        ...
                                        <div class="text-center">
                                            ...
                                            <button type="button" class="btn btn-link btn-floating mx-1">
                                                <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid
                                                   &redirect_uri=http://localhost:8080/KV_Sneakers/login
                                                   &response_type=code
                                                   &client_id=686771507932-q4804ap4n8hsrdvl30ssmj7d891qc90t.apps.googleusercontent.com
                                                   &approval_prompt=force" target="_blank">
                                                    <i class="fab fa-google"></i> Sign in with Google
                                                </a>
                                            </button>
                                            <p class="mt-3">Don't have an account? <a href="register.jsp" class="text-primary">Sign up</a></p>
                                        </div>
                                    </form>
                                </div>
                            </div>
