<%-- 
    Document   : card
    Created on : Nov 27, 2024, 7:29:19 PM
    Author     : thaiv
--%>
    ...
    <body>
        ...
        <div class="container py-5">
                ...
                <tbody>
                    ...
                    <c:forEach var="item" items="${cartItems}">
                        <tr>
                            ...
                            <td>
                                <form action="AddCart" method="get" class="d-flex justify-content-center">
                                    <input type="hidden" name="action" value="update">
                                    <input type="hidden" name="productId" value="${item.product.productId}">
                                    <input type="number" name="quantity" value="${item.quantity}" class="form-control w-50 text-center">
                            ...
                            <td>
                                <c:if test="${item.product != null}">
                                    <a href="AddCart?action=delete&productId=${item.product.productId}" class="btn btn-sm btn-danger">
                                        Delete
                                    </a>
                                </c:if>
                            </td>
            ...
            <div class="text-right">
                ...
                <a href="CheckoutServlet" class="btn btn-success ml-2">Pay</a>
            </div>
        </div>
