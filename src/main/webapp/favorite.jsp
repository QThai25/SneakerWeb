                        ...
                        <div class="navbar-nav w-100 overflow-hidden" style="height: 200px">
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                    <a href="favorite?id=5&cat_name=Ananas" class="dropdown-item">Ananas</a>
                                    <a href="favorite?id=6&cat_name=Bitis" class="dropdown-item">Bitis</a>
                                    <a href="favorite?id=7&cat_name=Shondo" class="dropdown-item">Shondo</a>
                                </div>
                            </div>
                        </div>
                    </nav>
