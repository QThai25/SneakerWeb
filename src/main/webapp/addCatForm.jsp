        ...
        <div class="container mt-5">
            ...
            <form action="addCategory" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="" name="decription" rows="4" required></textarea>
                </div>

                <button style="margin-left: 42%" type="submit" class="btn btn-primary">Add Category</button>
            </form>
        </div>
