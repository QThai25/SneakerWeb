                        ...
                        <div class="navbar-nav w-100 overflow-hidden" style="height: 200px">
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu bg-secondary border-0 rounded-0 w-100 m-0">
                                    <a href="famous?id=1&cat_name=Balenciaga" class="dropdown-item">Balenciaga</a>
                                    <a href="famous?id=2&cat_name=Chanel" class="dropdown-item">Chanel</a>
                                    <a href="famous?id=3&cat_name=Dior" class="dropdown-item">Dior</a>
                                    <a href="famous?id=4&cat_name=Gucci" class="dropdown-item">Gucci</a>
                                </div>
                            </div>
                        </div>
                    </nav>
