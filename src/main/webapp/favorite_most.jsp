                        ...
                        <div class="navbar-nav w-100 overflow-hidden" style="height: 200px">
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu position-absolute bg-secondary border-0 rounded-0 w-100 m-0">
                                    <a href="favorite_most?id=8&cat_name=Adidas" class="dropdown-item">Adidas</a>
                                    <a href="favorite_most?id=9&cat_name=Converse" class="dropdown-item">Converse</a>
                                    <a href="favorite_most?id=10&cat_name=Jordan" class="dropdown-item">Jordan</a>
                                    <a href="favorite_most?id=11&cat_name=New Balance" class="dropdown-item">New Balance</a>
                                    <a href="favorite_most?id=12&cat_name=Nike" class="dropdown-item">Nike</a>
                                    <a href="favorite_most?id=13&cat_name=Vans" class="dropdown-item">Vans</a>
                                </div>
                            </div>
                        </div>
                    </nav>
