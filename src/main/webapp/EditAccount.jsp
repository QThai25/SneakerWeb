...
<html>
    <head>
        ...
        <style>
            ...
            .user-card-buttons input[type="submit"] {
            ...
            .user-card-buttons input[type="button"]:hover {
    ...
    <body>
        ...
        <a href="AddAccount" style="margin-bottom: 10px;" class="btn btn-primary btn-sm">Add Account</a>
                ...
                <form action="EditAccount" method="post">
                    <div class="user-card-card">
                        <div class="user-card-info">
                            ...
                            <p><strong>Birthday:</strong> ${users.birthday}</p>
                        </div>
