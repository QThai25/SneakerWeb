...
<html>
    ...
    <body>
        ...
        <div class="text-center mb-4">
            <h2 class="section-title px-5"><span class="px-2">${catName}</span></h2>
        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                    <div class="card product-item border-0 mb-4">
                        <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                            ...
                            <img style="width: 300px; height: 400px;" class="img-fluid w-100" src="${product.image}" alt="${product.name}">
                        </div>
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            ...
                            <a href="ViewDetails?id=${product.productId}" class="btn btn-sm text-dark p-0">
                                <i class="fas fa-eye text-primary mr-1"></i>View Detail
                            </a>
                            <!-- Nút thêm vào giỏ hàng -->
                            <a href="AddCart?action=addItem&productId=${product.productId}&quantity=1" class="btn btn-sm text-dark p-0">
