...
<html>
    <head>
        ...
        <style>
            ...
            .feedback-message-container .btn {
            ...
            .feedback-message-container .btn:hover {
    ...
    <body>
        ...
        <div class="feedback-message-container text-center my-5">
            <h2 class="feedback-title text-primary">Thank You!</h2>
            <p >
                We have received your feedback!<br>
                We will respond as soon as possible.<br>
                Thank you for using our service.
            </p>
            <a href="home.jsp" class="btn btn-outline-primary mt-3">Return to Home</a>
        </div>
