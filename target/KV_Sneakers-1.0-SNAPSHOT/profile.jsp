    ...
    <body>
        ...
        <div class="container">
            ...
            <%
                ...
                String userId = request.getParameter("id"); // Lấy ID từ URL
                String fullName = "";
                String birthYear = "";
                String phoneNumber = "";
                ...
                if (userId != null) {
                    try {
                        ...
                        String sql = "SELECT [fullname], [birthday], [phone] FROM users WHERE [user_id] = ?";
                        ...
                        if (resultSet.next()) {
                            ...
                            birthYear = resultSet.getString("birthday");
                    ...
                    out.println("<p>Vui lòng cung cấp ID người dùng.</p>");
                }
            %>
            <div class="profile-info">
                <p><span class="label">Họ và tên:</span> <%= fullName%></p>
                <p><span class="label">Năm sinh:</span> <%= birthYear%></p>
                <p><span class="label">Số điện thoại:</span> <%= phoneNumber%></p>
            </div>
        </div>    
